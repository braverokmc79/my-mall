	...
	<div class="row">
							...
							<td>
								<div class="form-inline">
								   <div class="form-group">
									 ...
									 <input type="hidden"  name="salePersent" id="salePersent" value="0">
									</div>
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									...
									<input type="hidden"  name="reservesPersent" id="reservesPersent" >
									</div>
		...
		<input type="checkbox"   name="productSize[]"  value ="XL" >XL&nbsp;
						...
						<tr>
							...
							<td colspan="5"><textarea rows="8" cols="50" name="contractContent" id="contractContent" placeholder="2000자 내외"></textarea>
							</td>
						</tr>
