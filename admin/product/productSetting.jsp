...
<div id="page-wrapper">
	...
	<div class="row">
				...
				<form name="frm" method="post"  >
					...
					<table id="productList" class="table">
						...
						<tr>
							...
							</select> &nbsp;2차 분류 : <select name="kind2" id="kind2"  class="form-control">
						...
						<tr>
							...
							<td>
								<label>   
							   베스트 상품 품목으로 선택 <input type="checkbox" name='bestyn'  value="y" >
							</label>
							</td>
						...
						<tr>
								...
								<div class="form-inline">
									<div class="form-group">
										<label for="price1">원가[A]</label> <input type="text"
											...
											name="price1" onkeyup="NumFormat(this)">
									</div>
									...
									<div class="form-group">
										<label for="price2">판매가[B]</label> <input type="email"
											...
											onblur="go_ab()" onKeyUp="NumFormat(this)" placeholder="판매가">
									</div>
							...
							<td rowspan="1" align="center" style="background-color: ;">
									<div class="form-group">
										<label for="price3">순이익</label> <input type="text"
											name="price3" readonly="readonly" class="form-control"  id="price3">
									</div>
								...
								<div class="form-inline">
									<div class="form-group">
										<label for="salePrice1"></label> <input type="text"
											...
											placeholder="세일가격" onblur="go_sale()" class="form-control">
									</div>
								...
								<div class="form-inline">
									<div class="form-group">
										<label for="totalNumber"></label> <input type="text"
											...
											placeholder="총개수" class="form-control">
									</div>
								...
								<div class="form-inline">
									<div class="form-group">
										<label for="resrveSelect"></label> <select id="resrveSelect" class="form-control">
											<option selected="selected" id="zero" value="0">0</option>
									...
									<label for="reserves"> 결과 :</label> <input type="text"
										readonly="readonly" value="적립급액 없음" name="reserves"
								...
								<div class="form-inline">
									<div class="form-group">
										...
										<div class="bfh-selectbox bfh-countries open"
											data-country="KR" data-flags="true" id="countryDiv">
									...
									<label for="Scountry"> 선택국가 :</label> <input type="text"
										readonly="readonly" value="선택국가 없음" name="Scountry"
										id="Scountry" class="form-control">
		...
		<div id="reportrange1" class="from-control" >
			...
			<b class="caret"></b>
			<input type="hidden" name="productDate" id="productDate" >
		...
		<input type="checkbox"   name="productSize[]"  value ="XL" >XL&nbsp;
					...
					<div class="form-inline">		
					  기간 
					  <div id="reportrange2" class="from-control" >
			<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>&nbsp; <span></span>
			<b class="caret"></b>
			<input type="hidden" name="hiteDate1" id="hiteDate1" >
		  

		  
		  </div>
		 <div id="reportrange3" class="from-control" >
			<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>&nbsp; <span></span>
			<b class="caret"></b>
			<input type="hidden" name="hiteDate2" id="hiteDate2" >
		  
		  
		  </div>		    
					  
					기간내 판매량 수요량  <input type="text"  name="hitAmount" class="form-control" onkeyup="NumFormat(this)" >	
        			</div>	
				...
				<tr>
							<th> 핫상품 설정 <small class='essentialText'>(추천수)</small> </th>
							 <td>
							 <input type="text" class="form-control"  onkeyup="NumFormat(this)" name="recommendRange" placeholder="예 )10개이상이면 핫 상품">
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="5"><textarea rows="8" cols="50" name="contractContent" placeholder="2000자 내외"></textarea>
							</td>
						</tr>
				    	...
				    	<td colspan="5"><textarea rows="8" cols="50" name="content" id="content" ></textarea>
							</td>
			...
			<tr>
			   <th>상품 대표 이미지  <small class='essentialText'>(필수 입력)</small></th>
				<td colspan="5">
				   <div id="thumnail">
				 <input type='hidden' name='oldImg' value='' class='form-control'>
				 </div>
				</td>
			</tr>
		</table>
				 ...
				 <input type="submit" value="전송"  id="fileSubmit" style="display: none;">						
					...
					<div style="text-align: center;">
						<input type="button" class="btn btn-success" value="등록"
							onclick="go_save()" /> <input type="button"
							class="btn btn-warning" value="취소" onclick="go_mov()" />
					</div>
